...
@class MIWSPTData, MIWSPTAddress;
@protocol MIWSPTChannelDelegate;

@interface MIWSPTChannel : NSObject

// Delegate
@property (strong) id<MIWSPTChannelDelegate> delegate;

// Communication protocol. Must not be nil.
@property MIWSPTProtocol *protocol;
...
@interface MIWSPTAddress : NSObject
...
@protocol MIWSPTChannelDelegate <NSObject>
